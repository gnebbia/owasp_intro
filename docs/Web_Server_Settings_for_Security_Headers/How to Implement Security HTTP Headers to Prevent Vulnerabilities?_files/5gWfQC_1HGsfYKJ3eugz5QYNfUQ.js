...
return false}}());CloudflareApps.installs["KsiBCYsYLmLV"]={appId:"lMxPPXVOqmoE",scope:{}};;CloudflareApps.installs["KsiBCYsYLmLV"].options={"anonymizeIp":false,"id":"UA-58443135-1","social":true};;CloudflareApps.installs["z9rUFgy18kA0"]={appId:"nt4L5NPJq1za",scope:{}};;CloudflareApps.installs["z9rUFgy18kA0"].options={"blocks":[{"code":"\u003c!-- Hotjar Tracking Code for geekflare.com --\u003e\n\u003cscript\u003e\n    (function(h,o,t,j,a,r){\n        h.hj=h.hj||function(){(h.hj.q=h.hj.q||[]).push(arguments)};\n        h._hjSettings={hjid:98263,hjsv:6};\n        a=o.getElementsByTagName('head')[0];\n        r=o.createElement('script');r.async=1;\n        r.src=t+h._hjSettings.hjid+j+h._hjSettings.hjsv;\n        a.appendChild(r);\n    })(window,document,'https://static.hotjar.com/c/hotjar-','.js?sv=');\n\u003c/script\u003e","location":{"method":"append","selector":"head"}}]};;CloudflareApps.installs["z9rUFgy18kA0"].URLPatterns=["^tools.geekflare.com/?.*$"];;CloudflareApps.installs["z9rUFgy18kA0"].selectors={"blocks[0].location.selector":"head"};;if(CloudflareApps.matchPage(CloudflareApps.installs['KsiBCYsYLmLV'].URLPatterns)){(function(){var options=CloudflareApps.installs['KsiBCYsYLmLV'].options;var id;if(options.account&&options.organization){id=options["web-properties-for-"+options.organization];}else{id=(options.id||"").trim();}
if(!id){console.log("Cloudflare Google Analytics: Disabled. UA-ID not present.");return;}else if("KsiBCYsYLmLV"==="preview"){console.log("Cloudflare Google Analytics: Enabled",id);}
...
gtag("event","share",{method:"twitter",event_action:"tweet",content_id:targetUrl});}});}},false);}})();};if(CloudflareApps.matchPage(CloudflareApps.installs['z9rUFgy18kA0'].URLPatterns)){(function(){'use strict'
if(!document.addEventListener)return
var options=CloudflareApps.installs['z9rUFgy18kA0'].options
var elements={}
var prevElements={}
...
window.CloudflareApps.installs['z9rUFgy18kA0'].scope={setOptions:function(nextOptions){options=nextOptions
updateElements()}}}())}